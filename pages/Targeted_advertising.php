  ...
  <div  class="menu">
    ...
    <main>
        ...
        <div class="bloc">
            ...
            <p class="this">Таргетированная реклама — это реклама в социальных сетях (ВКонтакте, Одноклассники, РСЯ), которая приведет к вам вашу целевую аудиторию, побудит её перейти по ссылке на сайт, совершить покупку, оставить контактные данные, а также повысит узнаваемость бренда.</p>
