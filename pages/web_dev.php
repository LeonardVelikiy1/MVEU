  ...
  <div  class="menu">
    ...
    <main>
        ...
        <div class="bloc">
            ...
            <p class="this"><b>Сайт</b> — это основная площадка, которая презентует вашу компанию и предлагает её продукты клиентам, инвесторам, партнерам, потенциальным сотрудникам, а также помогает собирать от них заявки на сотрудничество. Сайт является важнейшим инструментом для увеличения продаж. </p>
            <p class="description">Что входит в нашу работу?</p>
            <p class="description-works">Выяснение ваших потребностей, разработка технического задания;<br>
            <br>Разработка макета сайта (в виде наглядных прототипов блок — схем с расположением элементов и текстов);<br>
            <br>Разработка дизайна (в формате картинок на основе прототипов);<br>
            <br>Выполнение верстки страниц сайта (на основе утвержденного макета);<br>
            <br>Программирование сайта;<br>
            <br>Наполнение сайта контентом; <br>
            <br>Отладка и тестирование на предмет ошибок;<br>
            <br>Сдача сайта заказчику и демонстрация проделанной работы;<br>
            <br>Размещение сайта на хостинг заказчика и подключение домена заказчика.<br></p>
        </div>
        <div>
