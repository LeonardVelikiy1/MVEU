  ...
  <div  class="menu">
    ...
    <main>
        ...
        <div class="bloc">
            ...
            <p class="this"><b>Сайт — это основная площадка, которая презентует вашу компанию и предлагает её продукты клиентам, инвесторам, партнерам, потенциальным сотрудникам, а также помогает собирать от них заявки на сотрудничество. Сайт является важнейшим инструментом для увеличения продаж. </p>
