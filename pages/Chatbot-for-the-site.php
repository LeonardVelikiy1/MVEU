...
<head>
  ...
  <div  class="menu">
    ...
    <main>
        ...
        <div class="bloc">
            <p class="Targeted-advertising">Чат-бот для сайта</p>
            <p class="this"><b>Чат бот для сайта</b> — это онлайн-консультант компании, автоматизированная система, которая облегчит работу службе клиентской поддержки и разгрузит её от решения типовых запросов/задач.</p>
